...
if(mysqli_query($link, $sql)){
        ...
        echo "<tr><td>id</td> <td>goods</td> <td>price</td></tr>";
        while($row = mysqli_fetch_array( $sql_get ))
        {
...
echo '<br><a href="clearcart.php"><input type=button value="Clear cart"></a>';
echo '<p></p>';
echo '<br><a href="confirm.php"><input type=button value="Confirm"></a>';
echo '</div>';
echo '</section>';
echo '</main>';
echo '</body>';
